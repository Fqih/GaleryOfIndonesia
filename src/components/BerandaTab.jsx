      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4">
        <div className="max-w-4xl mx-auto text-center bg-white/70 p-10 rounded-2xl backdrop-blur-sm border border-white/50 shadow-xl">
          ...
          <button 
            ...
            className="bg-amber-700 text-white px-8 py-4 rounded-full text-xl font-semibold hover:bg-amber-800 transition shadow-xl hover:shadow-2xl transform hover:-translate-y-1 flex items-center mx-auto gap-3"
          >
