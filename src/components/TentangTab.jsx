    ...
    <section className="py-20 px-4 bg-white min-h-screen">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-gray-50 p-8 rounded-2xl border border-gray-200 mb-8">
          <h3 className="text-xl font-serif font-bold text-gray-900 mb-4">WarisanBudaya: Warisan Budaya Virtual</h3>
          <p className="text-gray-700 leading-relaxed mb-4">
            WarisanBudaya adalah prototipe aplikasi web multimedia interaktif yang menyajikan pameran budaya
